...
| Log Source                | Events  | Key Practice Area                    |
|---------------------------|---------|--------------------------------------|
| Wazuh (index_2.5k)        | 4,188   | CIS compliance, SIEM alerting        |
| Wazuh alerts              | 178     | Privilege escalation, PAM, AppArmor  |
| Windows failed logons     | 678     | Brute force detection, Event ID 4625 |
| Windows successful logons | 197,868 | Kerberos auth, baseline monitoring   |
| Windows general logs      | 158,135 | Service events, AD visibility        |
| pfSense firewall          | 4,826   | Network segmentation, default-deny   |
| Kali Linux logs           | 9,973   | Syslog ingestion, sourcetype config  |
